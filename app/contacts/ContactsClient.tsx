        ...
        items: [
            {
                ...
                answer: "Сроки изготовления согласовываются индивидуально (по договоренности) в зависимости от объема заказа и загруженности производства.",
            },
            {
                question: "Где находится ваше производство?",
                answer: "Наш завод расположен в Свердловской области. Мы располагаем полным циклом производства: от лазерной резки металла до порошковой покраски и сборки изделий с деревянными элементами.",
            },
            {
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                answer: "Да, у нас есть собственные монтажные бригады в Свердловской области. Для других регионов мы предоставляем подробные инструкции по сборке и установке, либо можем организовать шеф-монтаж для крупных объектов.",
            },
            {
